...
class App extends Component {
    componentDidMount() {
        if (isWeb3Injected()) {
            ...
            web3.eth.getBlockNumber().then(blockNumber => {
                ...
                this.props.dispatch(fetchOpenGames(this.Bet))
    ...
    addListeners() {
        this.creationEvent = this.Bet.events.GameCreated({
        ...
        this.acceptedEvent = this.Bet.events.GameAccepted({
